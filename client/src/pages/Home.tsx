          ...
          >
            ...
            <div className="container mx-auto text-center relative z-10">
              <h1 className="text-4xl md:text-6xl font-extrabold mb-6 tracking-tight drop-shadow-md">
                Ласкаво просимо до авторозбірки
              </h1>
              ...
              <Link 
                to="/products" 
                className="inline-block bg-blue-600 hover:bg-blue-500 text-white font-bold py-4 px-10 rounded-full transition-all duration-300 transform hover:scale-105 shadow-xl text-lg hover:shadow-blue-500/50"
              >
                Перейти в каталог
              </Link>
            </div>

...
import { FaBoxOpen, FaCalendarAlt, FaMapMarkerAlt, FaMoneyBillWave } from 'react-icons/fa';
      ...
      <div className="space-y-6">
        {orders.map((order) => (
          <div key={order.id} className="bg-white rounded-lg shadow-md border border-gray-200 overflow-hidden hover:shadow-lg transition-shadow">
            ...
            <div className="p-6">
                <div className="mb-4 text-sm text-gray-600 flex items-start gap-2 bg-blue-50 p-3 rounded">
